<template>
    <div data-v-headerChannel>
        <div class="channel-container left-channel-container">
            <a class="channel-item" href="//t.bilibili.com" target="_blank">
                <div class="icon-bg icon-bg__dynamic" v-html="icons.dynamic"></div>
                <span class="icon-title">动态</span>
            </a>
            <a class="channel-item" href="//www.bilibili.com/v/popular/all" target="_blank">
                <div class="icon-bg icon-bg__popular" v-html="icons.popular"></div>
                <span class="icon-title">热门</span>
            </a>
            <a class="channel-item" href="//www.bilibili.com/v/channel" target="_blank">
                <div class="icon-bg icon-bg__channer" v-html="icons.channel"></div>
